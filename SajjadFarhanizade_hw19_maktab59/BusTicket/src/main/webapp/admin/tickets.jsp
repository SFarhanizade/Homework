...
<%
    List<Ticket> tickets = new TicketService().loadAll();
    if (tickets != null) {
%>
<html>
<head>
...
<table class="table text-center w-75 m-auto">
    ...
    <%
        for (Ticket ticket : tickets) {
            ...
            String parameters = "id=" + id + "&name=" + ownerName + "&ownerId=" + ownerId + "&gender=" + gender + "&origin=" + origin
    ...
    <tr>
        ...
        <td><%=ticket.getTravel().getOrigin().getName() + " - " + ticket.getTravel().getDestination().getName()%>
        </td><td><%=ticket.getTravel().getDate()%>
        </td>
    </tr>
    <%
        }
